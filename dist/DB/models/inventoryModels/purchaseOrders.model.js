...
exports.PurchaseOrdersSchema.index({ requestNumber: 1 });
exports.PurchaseOrdersSchema.index({ branchId: 1 });
exports.PurchaseOrdersSchema.index({ requestedBy: 1 });
exports.PurchaseOrdersSchema.index({ status: 1 });
exports.PurchaseOrdersSchema.index({ requestDate: -1 });
exports.PurchaseOrdersSchema.index({ isDeleted: 1 });
exports.PurchaseOrdersSchema.index({ createdAt: -1 });
