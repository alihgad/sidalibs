...
export declare const StockInBranchSchema: import("mongoose").Schema<StockInBranch, Model<StockInBranch, any, any, any, import("mongoose").Document<unknown, any, StockInBranch, any> & StockInBranch & {
    ...
    __v: number;
}, any>, {}, {}, {}, {}, import("mongoose").DefaultSchemaOptions, StockInBranch, import("mongoose").Document<unknown, {}, import("mongoose").FlatRecord<StockInBranch>, {}> & import("mongoose").FlatRecord<StockInBranch> & {
    _id: Types.ObjectId;
} & {
    __v: number;
}>;
